(ns marketentry.store
  "SSoT for the DNK market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems DK" :portal "Udbud.dk"
             ...
             :requires-cvr? true :cvr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "DNK" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Udbud.dk"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-cvr? true :cvr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Udbud.dk"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "DNK" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Udbud.dk"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "DNK" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Udbud.dk"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-cvr? true :cvr-verified? false
             :drafted? false :submitted? false
             :jurisdiction "DNK" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Udbud.dk"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-cvr?)    (assoc :engagement/requires-cvr? requires-cvr?)
    (some? cvr-verified?)    (assoc :engagement/cvr-verified? cvr-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-cvr? :engagement/cvr-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-cvr? (boolean (:engagement/requires-cvr? m))
     :cvr-verified? (boolean (:engagement/cvr-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-dnk"})
